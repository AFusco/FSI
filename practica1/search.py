...
def branch_and_bound_tree_search(problem):
    return tree_search(problem, PriorityQueue(min, lambda x : x.path_cost))
...
def branch_and_bound_tree_search_with_underestimation(problem):
    return tree_search(problem, PriorityQueue(min, lambda x : x.path_cost + problem.h(x)))

def branch_and_bound_graph_search_with_underestimation(problem):
